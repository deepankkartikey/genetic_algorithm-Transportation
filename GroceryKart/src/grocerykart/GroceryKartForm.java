...
//            g.tournamentSelection();
    ...
    /*
     * The method is called in generatePopulation and 
    greedyGeneratePopulation etc.
     * It generates routes in a given candidate of 600 
    nodes by statisfying the
     ...
     * Based on greedy strategy it takes the nearest node 
    in a given euclidRadius
     * It then keeps on adding the nearest neighbours, 
    finally appending the last
     * 600th node completing a candidate, generating routes 
